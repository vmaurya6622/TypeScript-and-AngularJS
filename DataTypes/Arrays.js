...
var reversednums = newarray.reverse(); // reverses the array
...
var splicedarray = newarray.splice(2, 3); // removes 3 elements from index 2
var addingOnlyOneElement = newarray.splice(2, 0, 3); // this is used to add only one element at index 2
...
var splicedarrayadd = newarray.splice(2, 0, 20, 25); // adds 20,25 at index 2
//Removing elements using splice
var removedarray = newarray.splice(3, 2); // removes 2 elements from index 3
var removedarraystart = newarray.splice(0, 2); // removes 2 elements from start
var removedarrayend = newarray.splice(-2, 2); // removes 2 elements from end
var items = ["A", "B", "C", "D"];
var indexi = items.indexOf("C");
if (indexi !== -1) {
